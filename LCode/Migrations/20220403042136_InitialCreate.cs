        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Channels_Priorities_PriorityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientsTypes_Priorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "Priorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketTypes_Priorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "Priorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Tickets_Tickets_ChainId",
                        column: x => x.ChainId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientsTypes_PriorityId",
                table: "ClientsTypes",
                column: "PriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ChainId",
                table: "Tickets",
                column: "ChainId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketTypes_PriorityId",
                table: "TicketTypes",
                column: "PriorityId");
        }
